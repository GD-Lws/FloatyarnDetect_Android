...
//    matOut = Mat::ones(matIn.size(), matIn.type());
//    __android_log_print(ANDROID_LOG_INFO, TAG, "matIn%d",matIn.type());
    __android_log_print(ANDROID_LOG_INFO, TAG, "detect_flag_1 %d",detect_flag_1);
    __android_log_print(ANDROID_LOG_INFO, TAG, "detect_flag_2 %d",detect_flag_2);
